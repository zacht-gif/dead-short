...
const MUTATIONS = [
  ...
  },
  {
    ...
    file: 'index.html',
    find: "    startMetronome();",
    replace: "    startMetronome(); stepTick();",
  ...
  },
  {
    ...
    find: "        sfx.click();\n      }\n      takeTurn();",
    replace: "        sfx.click();\n      }",
    expect: 'picking a wire is what starts the clock',
    note: 'a keyboard-only player gets a board that never moves; the mouse is fine',
  },
  {
  ...
  {
    id: 'dead-wait-control-returns',
    file: 'index.html',
    find: '<button id="previewBtn"',
    replace: '<button id="waitBtn">Wait</button><button id="previewBtn"',
    expect: 'a Wait button is back in the play screen markup',
    note: 'a control that spends nothing and does nothing, in a game priced in seconds',
  },
  {
